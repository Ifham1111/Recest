...
//     return () => console.log("Hi component unmounted");
//   },[]);
...
function GrowingPlant(props) {
  ...
  // const [displayHi, setdisplayHi] = useEffect(false);
...
//     this.state = {
//       dynamicSize: props.plantData.size
//     }
//   };

//   handleClick = () => {
//     this.setState({dynamicSize: this.dynamicSize + 20});
//   };
...
//         <button onClick={this.handleClick}>Givewater</button>
//       </div>
//     );
//   }
// }
